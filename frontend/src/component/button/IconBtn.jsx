...
const perfilIcon = <svg width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M1.99999 15.75H8.99999H16C17 14.25 15.4 10.25 8.99999 10.25C2.59999 10.25 0.999991 14.25 1.99999 15.75Z" stroke="#F5F5F5" stroke-width="2"/>
  <circle cx="8.72552" cy="4.25" r="3" stroke="#F5F5F5" stroke-width="2"/>
</svg>
